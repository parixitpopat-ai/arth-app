      ...
      stats: (
        <div key="stats" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10 }}>
          {[
            ...
            {label:"To Receive",value:`${sym}${fmt(monthTotalOwedToMe + loanGivenTotal)}`,color:T.accent,icon:"🔄",action:()=>setShowReceivablesList(true),sub:loanGivenTotal>0?`incl. ${sym}${fmtK(loanGivenTotal)} loans`:undefined},
