...
const CAT_ICONS = ["ðŸ½ï¸","ðŸ•","ðŸ”","ðŸœ","ðŸ¥—","ðŸ£","â˜•","ðŸº","ðŸ›’","ðŸ¥©","ðŸš—","ðŸï¸","âœˆï¸","ðŸš•","â›½","ðŸ…¿ï¸","ðŸ›ï¸","ðŸ‘—","ðŸ‘Ÿ","ðŸ’„","ðŸ’","ðŸ§´","âš¡","ðŸ’§","ðŸ“¶","ðŸ”Œ","ðŸ’Š","ðŸ¥","ðŸ©º","ðŸ§˜","ðŸ‹ï¸","ðŸŽ¬","ðŸŽµ","ðŸŽ®","ðŸŽ¨","ðŸ“š","ðŸ ","ðŸ”§","ðŸª´","ðŸ›‹ï¸","ðŸ‘¶","ðŸ§’","ðŸŽ’","âœï¸","ðŸ§¸","ðŸ’°","ðŸ’³","ðŸ“ˆ","ðŸ¦","ðŸª™","ðŸ‘¤","ðŸ•","ðŸˆ","ðŸŒ¿","ðŸŒ","â˜€ï¸","ðŸŽ","ðŸŽ‚","ðŸ’¼","ðŸ–¥ï¸","ðŸ“±","ðŸ”­","ðŸª’","ðŸ’‡","ðŸ’†","ðŸ’…","ðŸ§–","ðŸŠ","ðŸš´","â›³","ðŸŽ¯","ðŸŽª","ðŸŸï¸","ðŸš‘","ðŸ”‘","ðŸ›","ðŸ§º","ðŸª‘","ðŸ–¼ï¸","â›µ","ðŸŒŠ","â›°ï¸","ðŸŽ“","ðŸ“–","ðŸ›ï¸"];
const INVEST_TYPES = [{ id:"mf", name:"Mutual Funds / SIP", icon:"ðŸ“ˆ", color:"#3b82f6" },{ id:"stocks", name:"Stocks", icon:"ðŸ“Š", color:"#22c55e" },{ id:"fd", name:"Fixed Deposit", icon:"ðŸ¦", color:"#f0a500" },{ id:"gold", name:"Gold", icon:"ðŸ¥‡", color:"#f59e0b" },{ id:"ppf", name:"PPF / NPS", icon:"ðŸ›ï¸", color:"#8b5cf6" },{ id:"crypto", name:"Crypto", icon:"â‚¿", color:"#f97316" },{ id:"realestate", name:"Real Estate", icon:"ðŸ˜ï¸", color:"#06b6d4" },{ id:"custom", name:"Custom", icon:"ðŸ’¼", color:"#ec4899" }];
const ACC_TYPES = [{ id:"bank", label:"Bank Account", icon:"ðŸ¦" },{ id:"cc", label:"Credit Card", icon:"ðŸ’³" },{ id:"debit", label:"Debit Card", icon:"ðŸ§" },{ id:"upi", label:"UPI", icon:"ðŸ“±" },{ id:"cash", label:"Cash", icon:"ðŸ’µ" }];
const LIABILITY_TYPES = [{ id:"mortgage", name:"Mortgage / Home Loan", icon:"ðŸ ", color:"#f97316" },{ id:"student", name:"Student Loan", icon:"ðŸŽ“", color:"#8b5cf6" },{ id:"car", name:"Car Loan", icon:"ðŸš—", color:"#3b82f6" },{ id:"tax", name:"Tax Liability", icon:"ðŸ›ï¸", color:"#ef4444" },{ id:"personal", name:"Personal Loan", icon:"ðŸ¦", color:"#ec4899" },{ id:"other", name:"Other Liability", icon:"ðŸ“¦", color:"#78716c" }];
const ASSET_TYPES = [{ id:"realestate", name:"Real Estate", icon:"ðŸ ", color:"#06b6d4" },{ id:"vehicle", name:"Vehicle", icon:"ðŸš—", color:"#3b82f6" },{ id:"valuable", name:"Valuable", icon:"ðŸ’Ž", color:"#a855f7" },{ id:"gold", name:"Gold / Jewelry", icon:"ðŸ¥‡", color:"#f59e0b" },{ id:"other", name:"Other Asset", icon:"ðŸ“¦", color:"#22c55e" }];
...
const DEFAULT_CATS = [
  { id:"housing", name:"Housing", icon:"ðŸ ", color:"#06b6d4", budget:15000, fixed:true, subs:[{id:"h1",name:"Rent / EMI"},{id:"h2",name:"Maintenance"},{id:"h3",name:"Repairs"},{id:"h4",name:"Furniture & Appliances"},{id:"h5",name:"Renovation / Interiors"},{id:"h6",name:"Property Tax"}] },
  ...
  { id:"food", name:"Food & Dining", icon:"ðŸ½ï¸", color:"#f97316", budget:8000, fixed:false, subs:[{id:"f1",name:"Swiggy / Zomato"},{id:"f2",name:"Restaurants"},{id:"f3",name:"Cafes"},{id:"f4",name:"Treating Others"}] },
  ...
  { id:"fitness", name:"Fitness", icon:"ðŸ‹ï¸", color:"#14b8a6", budget:2000, fixed:false, subs:[{id:"fit1",name:"Gym"},{id:"fit2",name:"Sports"},{id:"fit3",name:"Yoga / Trainer"},{id:"fit4",name:"Fitness Apps"}] },
  ...
  { id:"travel", name:"Travel", icon:"âœˆï¸", color:"#06b6d4", budget:5000, fixed:false, subs:[{id:"tr1",name:"Flights"},{id:"tr2",name:"Trains / Buses"},{id:"tr3",name:"Hotels"},{id:"tr4",name:"Local Transport"},{id:"tr5",name:"Activities"},{id:"tr6",name:"Shopping"}] },
  ...
  { id:"taxes", name:"Taxes", icon:"ðŸ›ï¸", color:"#dc2626", budget:5000, fixed:true, subs:[{id:"tx1",name:"Income Tax"},{id:"tx2",name:"CA / Filing Fees"}] },
...
const accIcon = t => t==="bank"?"ðŸ¦":t==="cc"?"ðŸ’³":t==="debit"?"ðŸ§":t==="upi"?"ðŸ“±":"ðŸ’µ";
...
const txnEmoji = txnOrType => {
  ...
  return type==="income"?"💚":type==="transfer"?"🔄":type==="cc_payment"?"💳":type==="settlement_in"?"🔵":type==="settlement_out"?"📤":type==="investment"?"💹":"💸";
};
...
function AppContent({ onLock }) {
      ...
      <div style={{ borderBottom:!last?`1px solid ${T.border}`:"none" }}>
        ...
        <div onClick={()=>setExpandedTxn(isExpanded?null:t.id)} style={{ display:"flex", alignItems:"center", gap:12, padding:"11px 0", cursor:"pointer" }}>
          ...
          <div style={{ flex:1, minWidth:0 }}>
            <div style={{ color:t.writtenOff?T.sub:T.text, fontSize:13, fontWeight:700, marginBottom:2, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap", textDecoration:t.writtenOff?"line-through":"none" }}>
              {(t.type==="cc_payment"||t.type==="transfer")?t.desc||(t.merchant||"—"):(t.merchant||t.desc||"—")}
            </div>
        ...
        {isExpanded&&(
          <div style={{ background:T.input,borderRadius:12,padding:14,marginBottom:12 }}>
            ...
            {t.forPerson&&<div style={{ fontSize:11,color:"#ec4899",marginBottom:8 }}>👤 for {getPerson(t.forPerson).name}{t.tagPersonAmount&&t.tagPersonAmount!==t.amount?` · ${sym}${fmt(t.tagPersonAmount)} tracked`:""}</div>}
            ...
            {t.type==="expense"&&linkedRefunds.length>0&&<>
              ...
              <div style={{ display:"flex",gap:6,flexWrap:"wrap",marginBottom:8 }}>
                {linkedRefunds.map(row=><button key={row.id} onClick={e=>{ e.stopPropagation(); setExpandedTxn(null); setEditingTxn(row); }} style={{ background:T.info+"14",border:`1px solid ${T.info}33`,borderRadius:20,padding:"4px 10px",cursor:"pointer",fontSize:10,fontWeight:700,color:T.info,fontFamily:"Nunito,sans-serif" }}>↩ Open refund {sym}{fmt(row.amount)}</button>)}
              </div>
            ...
            {owedPeople.length>0&&!t.writtenOff&&(
              <div style={{ marginBottom:10 }}>
                ...
                <button onClick={writeOff} style={{ background:"none",border:`1px solid ${T.sub}44`,borderRadius:20,padding:"5px 14px",cursor:"pointer",fontSize:11,color:T.sub,fontFamily:"Nunito,sans-serif" }}>âœï¸ Write off {sym}{fmt(totalOwed)}</button>
              </div>
            )}

            <div style={{ display:"flex",gap:8,paddingTop:8,borderTop:`1px solid ${T.border}` }}>
              <button onClick={e=>{e.stopPropagation();setEditingTxn(t);setExpandedTxn(null);}} style={{ background:T.accentSoft,border:`1px solid ${T.accent}33`,borderRadius:8,padding:"7px 14px",cursor:"pointer",fontSize:11,fontWeight:700,color:T.accent,fontFamily:"Nunito,sans-serif" }}>âœï¸ Edit</button>
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:12 }}>
            ...
            {txnType==="expense"&&(
              <div>
                ...
                <div style={{ display:"flex",gap:8,marginBottom:12 }}>
                  {[["none","ðŸš«","None"],["split","âš–ï¸","Split"],["tag","ðŸ‘¤","Tag"]].map(([v,ic,lb])=>(
                    ...
                    {selectedPids.length>0&&(
                      <>
                        <div style={{ display:"flex",gap:6,marginBottom:10 }}>
                          {[["equally","= Equal"],["amount","â‚¹ Amount"],["percent","% Percent"],["share","âš–ï¸ Share"]].map(([v,lb])=>(
                    ...
                    {tagPerson&&(()=>{
                      ...
                      return (
                        <div style={{ background:T.input,borderRadius:12,padding:"12px 14px",marginBottom:10 }}>
                          <div style={{ color:T.text,fontSize:13,fontWeight:700,marginBottom:8 }}>{p.emoji} {p.name} — spend tracking</div>
                          ...
                          <div style={{ color:T.sub,fontSize:10,marginTop:8 }}>
                            This does NOT mean they owe you — it tracks what you spent on them.
                          </div>
                        </div>
                      );
                    })()}
            ...
            <div style={{ background:T.input,borderRadius:12,overflow:"hidden" }}>
              ...
              {showSms&&<div style={{ padding:"0 14px 14px" }}>
                ...
                {smsRaw&&<div style={{ color:T.success,fontSize:11,fontWeight:700 }}>✅ Parsed — check fields above</div>}
              </div>}
            </div>
            ...
            <div style={{ background:T.input,borderRadius:12,padding:"11px 14px",display:"flex",alignItems:"center",gap:10 }}>
              ...
              {imageBase64&&<button onClick={()=>setImageBase64(null)} style={{ background:"none",border:"none",color:T.danger,cursor:"pointer",fontSize:16 }}>✕</button>}
            </div>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"1fr 2fr",gap:10 }}>
              ...
              <button onClick={submit} style={{ ...btnP,opacity:canSubmit?1:0.5 }}>{canSubmit?"Add ✓":txnType==="investment"?"Fill name & amount":"Fill vendor & amount"}</button>
            </div>
          </div>
        </div>
      </div>
  ...
  const EditModal = ({ t, onClose }) => {
    ...
    return (
      <div onClick={e=>e.target===e.currentTarget&&onClose()} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200 }}>
        <div style={{ background:T.card,borderRadius:"22px 22px 0 0",padding:"20px 18px 40px",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto" }}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16 }}>
            <div style={{ color:T.text,fontSize:18,fontWeight:900 }}>âœï¸ Edit</div>
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:12 }}>
            ...
            {/* SMS section — always shown, collapsible */}
            <div style={{ background:T.input,borderRadius:12,overflow:"hidden" }}>
              <button onClick={()=>setShowSmsEdit(p=>!p)} style={{ width:"100%",background:"none",border:"none",padding:"10px 14px",cursor:"pointer",display:"flex",alignItems:"center",gap:8,fontFamily:"Nunito,sans-serif" }}>
                ...
                <span style={{ color:T.sub,fontSize:11 }}>{showSmsEdit?"▲":"▼"}</span>
              </button>
            ...
            {txnType==="expense"&&txns.filter(x=>x.type==="settlement_in" && x.againstTxnId && String(x.againstTxnId)===String(t.id)).length>0&&(
              <div style={{ background:T.input,borderRadius:12,padding:"12px 14px" }}>
                <div style={{ color:T.info,fontSize:12,fontWeight:800,marginBottom:8 }}>↩ Linked refund entries</div>
                <div style={{ display:"flex",gap:6,flexWrap:"wrap" }}>
  ...
  const AddAccountModal = () => {
    ...
    const submit=()=>{
      ...
      if(aType==="debit"&&!linkedBank){setError("Please link a bank account — required for debit cards");return;}
      ...
      <div onClick={e=>e.target===e.currentTarget&&setShowAddAccount(false)} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200 }}>
        <div style={{ background:T.card,borderRadius:"22px 22px 0 0",padding:"20px 18px 40px",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto" }}>
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:12 }}>
            ...
            {error&&<div style={{ color:T.danger,fontSize:12,fontWeight:700 }}>âš ï¸ {error}</div>}
            <div style={{ display:"grid",gridTemplateColumns:"1fr 2fr",gap:10 }}>
    ...
    const summaryCards = a.type==="cc"
      ...
      : [
          ...
          ...(checkpoint ? [
            ...
            { l:"Gap", v:`${(discrepancy||0)>=0?"+":"−"}${sym}${fmt(Math.abs(discrepancy||0))}`, c:Math.abs(discrepancy||0)<0.01?T.success:T.warn },
          ] : []),
        ];
        ...
        <div style={{ background:T.card,borderRadius:0,padding:"22px 18px 40px",width:"100%",maxWidth:"100vw",height:"100vh",maxHeight:"100vh",overflowY:"auto" }}>
          ...
          {checkpoint && a.type!=="cc" && (
            <div style={{ background:(Math.abs(discrepancy||0)<0.01?T.success:T.warn)+"14",border:`1px solid ${Math.abs(discrepancy||0)<0.01?(T.success+"44"):(T.warn+"44")}`,borderRadius:12,padding:"12px 14px",marginBottom:14 }}>
              ...
              <div style={{ color:Math.abs(discrepancy||0)<0.01?T.success:T.warn,fontSize:11,fontWeight:800 }}>{Math.abs(discrepancy||0)<0.01 ? "No gap — balances match." : `Discrepancy / gap: ${(discrepancy||0)>=0?"+":"−"}${sym}${fmt(Math.abs(discrepancy||0))}`}</div>
            </div>
          )}
          ...
          {a.type==="cc"&&<>
            ...
            {util>utilLimit&&<div style={{ background:T.danger+"22",border:`1px solid ${T.danger}44`,borderRadius:10,padding:10,marginBottom:14 }}>âš ï¸ <span style={{ color:T.danger,fontSize:12,fontWeight:700 }}>Current-cycle spend is above your {utilLimit}% alert limit</span></div>}
          </>}
              ...
              {ledgerRows.map((row,idx)=>(
                <div key={row.id} style={{ display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,padding:"10px 0",borderBottom:idx<ledgerRows.length-1?`1px solid ${T.border}`:"none" }}>
                  ...
                  <div style={{ textAlign:"right" }}>
                    <div style={{ color:row.color,fontSize:12,fontWeight:800 }}>{row.signed>=0?"+":"−"}{sym}{fmt(Math.abs(row.signed))}</div>
      ...
      stats: (
        <div key="stats" style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10 }}>
          {[
            ...
            {label:"Investment",value:`${sym}${fmt(totalInvested)}`,color:T.info,icon:"💹",action:()=>setShowInvestments(true)},
            ...
            {label:"To Receive",value:`${sym}${fmt(monthDirectOwedToMe)}`,color:T.accent,icon:"🔄",action:()=>setShowReceivablesList(true)},
            {label:"Net Savings",value:`${sym}${fmtK(Math.max(0,totalIncome-myActual-totalInvested))}`,color:T.success,icon:"💰",action:()=>setTab("home")},
          ].map(s=>(
      ...
      recent: txns.length>0 ? (
        <div key="recent" style={card}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12 }}>
            ...
            <button onClick={()=>setTab("transactions")} style={{ background:"none",border:"none",color:T.accent,fontSize:12,fontWeight:800,cursor:"pointer" }}>See all →</button>
          </div>
          {[...txns]
            .sort((a,b)=>{
  ...
  const People = () => {
    ...
    const addGroup=()=>{
      ...
      const gicon=gtlow.includes("house")||gtlow.includes("flat")||gtlow.includes("property")?"ðŸ ":gtlow.includes("trip")||gtlow.includes("travel")?"âœˆï¸":gtlow.includes("office")||gtlow.includes("work")?"ðŸ’¼":gtlow.includes("family")?"ðŸ‘¨â€ðŸ‘©â€ðŸ‘§":gtlow.includes("friend")?"ðŸ‘«":gtlow.includes("society")||gtlow.includes("building")?"ðŸ¢":"ðŸ‘¥";
          ...
          <div style={{ ...card,background:`linear-gradient(135deg,${p.color}14,${T.card})` }}>
            ...
            {(spent>0 || spendBudget>0)&&(
              <div style={{ background:T.input,borderRadius:10,padding:"10px 12px",marginBottom:14, border:`1px solid ${spendBudget>0 && spent>spendBudget ? T.danger : T.border}` }}>
                ...
                {spent>spendBudget && <div style={{ color:T.danger,fontSize:10,fontWeight:700,marginTop:4 }}>âš ï¸ Over budget by {sym}{fmt(spent-spendBudget)}</div>}</>}
              </div>
            )}
            ...
            <div style={{ display:"flex",gap:10 }}>
              <button onClick={()=>setEditingPerson(p)} style={{ ...btnP,background:T.accentSoft,border:`1px solid ${T.accent}33`,color:T.accent,flex:1 }}>{p.isMe?"ðŸŽ¯ Edit My Budget":"âœï¸ Edit Profile"}</button>
              {!p.isMe&&<button onClick={()=>{ setPeople(prev=>prev.filter(x=>x.id!==p.id)); setSelectedPerson(null); }} style={{ ...btnP,background:"transparent",border:`1px solid ${T.danger}`,color:T.danger,flex:1 }}>ðŸ—‘ï¸ Remove</button>}
            </div>
              ...
              <div style={{ flex:1 }}>
                {isEditingGroup ? (
                  ...
                  <div style={{ display:"flex",alignItems:"center",gap:8,flexWrap:"wrap" }}>
                    ...
                    <button onClick={startEditingGroup} style={{ background:T.accentSoft,border:`1px solid ${T.accent}33`,color:T.accent,borderRadius:20,padding:"4px 10px",cursor:"pointer",fontSize:11,fontWeight:700,fontFamily:"Nunito,sans-serif" }}>âœï¸ Edit Group</button>
                  </div>
                )}
                ...
                {(groupBudget>0 || groupTotalSpend>0) && (
                  <div style={{ marginTop:8, padding:10, borderRadius:10, background:groupOver?T.danger+"22":T.input, border:`1px solid ${groupOver?T.danger:T.border}` }}>
                    ...
                    {groupOver && <div style={{ color:T.danger, fontSize:11, fontWeight:700, marginTop:4 }}>âš ï¸ Over budget by {sym}{fmt(groupTotalSpend-groupBudget)}</div>}
                  </div>
                )}
    ...
    return (
      <div style={{ padding:"14px 16px 0" }}>
        <div style={{ display:"flex",gap:0,marginBottom:16,background:T.pill,borderRadius:12,padding:4 }}>
          {[["people","ðŸ‘¥ People"],["groups","ðŸ˜ï¸ Groups"]].map(([v,l])=>(
        ...
        {subView==="people"&&<>
              ...
              <div key={p.id} onClick={()=>setSelectedPerson(p)} style={{ ...card,cursor:"pointer",display:"flex",alignItems:"center",gap:12 }}>
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ color:T.sub,fontSize:11,marginTop:1 }}>
                    ...
                    {atLimit&&<span style={{ color:T.danger,fontSize:10,fontWeight:700,marginLeft:6 }}>âš ï¸ Credit limit</span>}
                  </div>
                </div>
          ...
          <div style={{ ...card,border:`1px dashed ${T.border}` }}>
            ...
            <div style={{ display:"flex",gap:8,marginBottom:10 }}>
              {[["contact","ðŸ¤ Contact","They may owe you"],["dependant","â™¥ Dependant","Family, you cover them"]].map(([v,l,sub])=>(
                  ...
                  return (
                    <div key={g.id} onClick={()=>{ setSelectedGroup(g); setEditingGroupName(g.name||""); setEditingGroupBudget(String(g.manualLimit||"")); setEditingGroupMembers([...(g.members||[])]); setIsEditingGroup(false); }} style={{ ...card,cursor:"pointer",display:"flex",alignItems:"center",gap:12 }}>
                      ...
                      <div style={{ flex:1 }}>
                        ...
                        <div style={{ color:gOver?T.danger:T.sub,fontSize:10,marginTop:2 }}>{gBudget>0?`Budget ${sym}${fmt(gBudget)} Â· `:""}Spent {sym}{fmt(gTotalSpend)}{gOver?` Â· âš ï¸ Over ${sym}${fmt(gTotalSpend-gBudget)}`:""}</div>
                      </div>
                      <div style={{ textAlign:"right" }}>
    ...
    return (
      <div style={{ padding:"14px 16px 0" }}>
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10 }}>
          {[{label:"Total",value:`${sym}${fmt(grandTotal)}`,color:T.info,icon:"ðŸ’¹"},{label:"Monthly",value:`${sym}${fmt(monthlyInvestmentCommitment)}`,color:T.purple,icon:"ðŸ”"},{label:"Folios",value:folioCount,color:T.success,icon:"ðŸ—‚ï¸"},{label:"This Month",value:`${sym}${fmt(totalInvested)}`,color:T.accent,icon:"ðŸ“…"}].map(s=>(
  ...
  const WealthPage = () => {
    ...
    const assetBreakdownItems = [
      { label:"Cash in bank", value:cashBankTotal, color:T.success, icon:"ðŸ¦", mode:"banks" },
      ...
      { label:"People owe you", value:directOwedToMe, color:T.accent, icon:"ðŸ¤", mode:"owed" },
      { label:"Loans given", value:loanGivenTotal, color:T.accent, icon:"🫴", mode:"loanGiven" },
      { label:"Tracked assets", value:trackedAssetsTotal, color:T.purple, icon:"ðŸ ", mode:"trackedAssets" },
    ];
  ...
  const Settings = () => {
    ...
    if(settingsSection==="income_types") return (
      <div style={{ padding:"14px 16px 0" }}>
        ...
        <div style={{ ...card,border:`1px dashed ${T.border}`,marginBottom:12 }}>
          <div style={{ color:T.text,fontSize:14,fontWeight:800,marginBottom:10 }}>➕ Add income type</div>
                    ...
                    <div key={a.id} style={{ ...card,cursor:"pointer" }} onClick={()=>setShowAccDetail(a)}>
                      <div style={{ display:"flex",alignItems:"center",gap:12 }}>
                        ...
                        <div style={{ display:"flex",gap:6,alignItems:"center" }}>
                          ...
                          <button onClick={e=>{e.stopPropagation();setEditingAccount(a);}} style={{ background:T.accentSoft,border:`1px solid ${T.accent}33`,borderRadius:8,padding:"3px 8px",cursor:"pointer",fontSize:10,fontWeight:700,color:T.accent,fontFamily:"Nunito,sans-serif" }}>âœï¸ Edit</button>
    ...
    if(settingsSection==="budget") return (
      <div style={{ padding:"14px 16px 0" }}>
        ...
        <div style={card}>
          <div style={{ color:T.text,fontSize:14,fontWeight:700,marginBottom:8 }}>Annual Budget (FY {new Date().getMonth()>=3?new Date().getFullYear():new Date().getFullYear()-1}–{new Date().getMonth()>=3?new Date().getFullYear()+1:new Date().getFullYear()})</div>
            ...
            return (
              <div key={m.key} onClick={()=>{ setViewMonth(m.key); setShowSettings(false); }} style={{ ...card,cursor:"pointer",marginBottom:8,border:`1px solid ${isCurrent?T.accent:T.border}`,background:isCurrent?T.accentSoft:T.card }}>
                <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:8 }}>
                  ...
                  <div style={{ fontSize:12,fontWeight:700,color:isOver?T.danger:T.success }}>{isOver?"−":"+"}{sym}{fmt(Math.abs(diff))}</div>
                </div>
            ...
            <div key={cat.id} style={card}>
              <div style={{ display:"flex",alignItems:"center",gap:12,marginBottom:8 }}>
                ...
                <div style={{ flex:1 }}>
                  ...
                  {cat.budget>0 && spent>cat.budget && <div style={{ color:T.danger,fontSize:11,fontWeight:700,marginTop:4 }}>âš ï¸ Over budget by {sym}{fmt(spent-cat.budget)}</div>}
    ...
    return (
      <div style={{ padding:"14px 0 0" }}>
        ...
        <div style={{ background:T.card,border:`1px solid ${T.border}`,borderRadius:16,marginBottom:16,overflow:"hidden",marginLeft:16,marginRight:16 }}>
          <Row icon="🌙" title="Dark Mode" subtitle="Switch between dark and light" right={<Toggle val={dark} fn={()=>setDark(d=>!d)}/>}/>
        ...
        <div style={{ background:T.card,border:`1px solid ${T.border}`,borderRadius:16,marginBottom:16,overflow:"hidden",marginLeft:16,marginRight:16 }}>
          <Row icon="📊" title="Import Bank Statement" subtitle="Coming in Phase 6"/>
          <Row icon="💾" title="Backup / Export" subtitle="Download your data"/>
        </div>
        ...
        <div style={{ background:T.card,border:`1px solid ${T.border}`,borderRadius:16,marginBottom:16,overflow:"hidden",marginLeft:16,marginRight:16 }}>
          <Row icon="🔒" title="Change PIN" onClick={()=>{ localStorage.removeItem("arth_pin"); window.location.reload(); }}/>
        ...
        <div style={{ background:T.card,border:`1px solid ${T.border}`,borderRadius:16,marginBottom:40,overflow:"hidden",marginLeft:16,marginRight:16 }}>
          <Row icon="💰" title="Arth" subtitle="Personal Finance · v3.0"/>
  ...
  const EditAccountModal = ({ a, onClose }) => {
    ...
    return (
      <div onClick={e=>e.target===e.currentTarget&&onClose()} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200 }}>
        <div style={{ background:T.card,borderRadius:"22px 22px 0 0",padding:"20px 18px 40px",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto" }}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16 }}>
            <div style={{ color:T.text,fontSize:18,fontWeight:900 }}>âœï¸ Edit {a.name}</div>
            <button onClick={onClose} style={{ background:T.pill,border:"none",color:T.sub,borderRadius:8,padding:"5px 11px",cursor:"pointer",fontSize:16,fontFamily:"Nunito,sans-serif" }}>✕</button>
          </div>
          <div style={{ display:"flex",flexDirection:"column",gap:12 }}>
  ...
  const BudgetPage = () => {
    ...
    return (
      <div style={{ padding:"14px 16px 0" }}>
        <div style={{ color:T.text,fontSize:20,fontWeight:900,marginBottom:14 }}>💰 Budget</div>
          ...
          return (
            <div key={m.key} onClick={()=>{ setViewMonth(m.key); setTab("home"); }} style={{ ...card,cursor:"pointer",border:`1px solid ${isCurrent?T.accent:T.border}`,background:isCurrent?T.accentSoft:T.card,opacity:isFuture?0.6:1,marginBottom:8 }}>
              <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:6 }}>
                ...
                <div style={{ fontSize:12,fontWeight:700,color:isOver?T.danger:T.success,minWidth:52,textAlign:"right" }}>{isOver?"−":"+"}{sym}{fmtK(Math.abs(diff))}</div>
              </div>
              <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center" }}>
                <span style={{ color:T.sub,fontSize:10 }}>Budget: {sym}{fmt(mBudget)}</span>
                <button onClick={e=>{ e.stopPropagation(); setEditingMonthBudget(m.key); setEditingMonthVal(fmt(mBudget)); }} style={{ background:"none",border:"none",color:T.info,fontSize:10,cursor:"pointer",fontFamily:"Nunito,sans-serif" }}>Edit</button>
  ...
  const EditBillModal = ({ b, onClose }) => {
    ...
    return (
      <div onClick={e=>e.target===e.currentTarget&&onClose()} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200 }}>
        <div style={{ background:T.card,borderRadius:"22px 22px 0 0",padding:"20px 18px 40px",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto" }}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16 }}>
            <div style={{ color:T.text,fontSize:18,fontWeight:900 }}>âœï¸ Edit Bill</div>
            <button onClick={onClose} style={{ background:T.pill,border:"none",color:T.sub,borderRadius:8,padding:"5px 11px",cursor:"pointer",fontSize:16,fontFamily:"Nunito,sans-serif" }}>✕</button>
          </div>
          <div style={{ display:"flex",flexDirection:"column",gap:12 }}>
            ...
            <div>
              ...
              {editSelectedPids.length>0&&<>
                <div style={{ display:"flex",gap:6,flexWrap:"wrap",marginBottom:8 }}>
                  {[["equally","= Equal"],["amount","â‚¹ Amount"],["percent","% Percent"],["share","âš–ï¸ Share"]].map(([v,l])=>(
            ...
            <div key={b.id} style={{ ...card,border:`1px solid ${isOverdue?T.danger+"44":T.border}` }}>
              <div style={{ display:"flex",alignItems:"flex-start",gap:12,marginBottom:10 }}>
                ...
                <div style={{ flex:1 }}>
                  ...
                  <div style={{ color:T.sub,fontSize:11,marginTop:2 }}>{getCat(b.catId||b.catIds?.[0])?.name||"â€”"}{b.recurring?` Â· ðŸ” ${b.frequency}`:""}</div>
                  ...
                  <div style={{ color:isOverdue?T.danger:daysUntil<=3&&b.status==="unpaid"?T.warn:T.sub,fontSize:11,marginTop:2 }}>
                    {b.status==="paid"?`âœ… Paid ${b.paidDate||""}`:isOverdue?`âš ï¸ ${Math.abs(daysUntil)}d overdue`:daysUntil===0?"Due today":`Due ${new Date(b.dueDate).toLocaleDateString("en-IN",{day:"numeric",month:"short"})}`}
                  </div>
                ...
                <div style={{ textAlign:"right" }}>
                  ...
                  <div style={{ display:"flex",gap:6,justifyContent:"flex-end",marginTop:4 }}>
                    <button onClick={()=>setEditingBill(b)} style={{ background:"none",border:"none",color:T.accent,fontSize:11,cursor:"pointer",fontFamily:"Nunito,sans-serif",fontWeight:700 }}>âœï¸</button>
                    <button onClick={()=>setBills(p=>p.filter(x=>x.id!==b.id))} style={{ background:"none",border:"none",color:T.danger,fontSize:11,cursor:"pointer",fontFamily:"Nunito,sans-serif" }}>🗑</button>
                  </div>
                </div>
              </div>
              {b.status==="unpaid"&&(
                <div style={{ display:"flex",gap:8,flexWrap:"wrap" }}>
                  ...
                  <button onClick={()=>setEditingBill(b)} style={{ background:T.accentSoft,border:`1px solid ${T.accent}33`,borderRadius:12,padding:"9px 14px",cursor:"pointer",fontSize:12,fontWeight:700,color:T.accent,fontFamily:"Nunito,sans-serif" }}>âœï¸ Edit</button>
                </div>
              )}
            </div>
          );
  ...
  const EditPersonModal = ({ p, onClose }) => {
    ...
    return (
      <div onClick={e=>e.target===e.currentTarget&&onClose()} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200 }}>
        <div style={{ background:T.card,borderRadius:"22px 22px 0 0",padding:"20px 18px 40px",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto" }}>
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16 }}>
            <div style={{ color:T.text,fontSize:18,fontWeight:900 }}>âœï¸ Edit {p.name}</div>
            <button onClick={onClose} style={{ background:T.pill,border:"none",color:T.sub,borderRadius:8,padding:"5px 11px",cursor:"pointer",fontSize:16,fontFamily:"Nunito,sans-serif" }}>✕</button>
          </div>
          <div style={{ display:"flex",flexDirection:"column",gap:12 }}>
  ...
  const TABS=[
    ...
    {id:"settings_tab",icon:"âš™ï¸",label:"Settings"}
  ];
          ...
          <div onClick={e=>e.target===e.currentTarget&&setShowInvestments(false)} style={{ position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",display:"flex",alignItems:"flex-end",justifyContent:"center",zIndex:200 }}>
            <div style={{ background:T.card,borderRadius:"22px 22px 0 0",width:"100%",maxWidth:430,maxHeight:"90vh",overflowY:"auto",paddingBottom:40 }}>
              <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center",padding:"20px 18px 0" }}>
                <div style={{ color:T.text,fontSize:18,fontWeight:900 }}>💹 Investments</div>
                <button onClick={()=>setShowInvestments(false)} style={{ background:T.pill,border:"none",color:T.sub,borderRadius:8,padding:"5px 11px",cursor:"pointer",fontSize:16,fontFamily:"Nunito,sans-serif" }}>✕</button>
              </div>
